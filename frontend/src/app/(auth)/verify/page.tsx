...
function VerifyContent() {
  ...
  return (
    <div className="w-full max-w-md mx-auto relative z-10 p-8 sm:p-10 bg-card border border-border shadow-2xl rounded-2xl overflow-hidden">
      ...
      <motion.div 
        ...
        animate={{
          background: [
            ...
            "radial-gradient(circle at 50% 100%, var(--primary) 0%, transparent 50%)",
      ...
      <div className="relative z-10 flex flex-col items-center">
        <motion.div
          ...
          className="w-20 h-20 mb-6 bg-primary/10 rounded-full flex items-center justify-center relative"
        >
          <div className="absolute inset-0 bg-primary/20 rounded-full animate-ping opacity-75"></div>
          <ShieldCheck className="w-10 h-10 text-primary z-10 relative" />
        </motion.div>

        <h1 className="text-3xl font-bold tracking-tight text-foreground mb-2 text-center">
          Secure Verification
        </h1>
        <p className="text-muted-foreground text-center mb-8 px-4 text-sm leading-relaxed">
          We've sent a 6-digit cryptographic code to <br/>
          <strong className="text-foreground">{email}</strong>
        </p>

        {/* Server Connection Animation */}
        <div className="flex items-center gap-4 mb-8 text-xs font-mono text-muted-foreground bg-muted/50 px-4 py-2 rounded-full border border-border">
